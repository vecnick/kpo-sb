...
set CLASSPATH=%APP_HOME%\lib\homework-1.0.jar;%APP_HOME%\lib\guice-5.1.0.jar;%APP_HOME%\lib\javax.inject-1.jar;%APP_HOME%\lib\aopalliance-1.0.jar;%APP_HOME%\lib\guava-30.1-jre.jar;%APP_HOME%\lib\failureaccess-1.0.1.jar;%APP_HOME%\lib\listenablefuture-9999.0-empty-to-avoid-conflict-with-guava.jar;%APP_HOME%\lib\jsr305-3.0.2.jar;%APP_HOME%\lib\checker-qual-3.5.0.jar;%APP_HOME%\lib\error_prone_annotations-2.3.4.jar;%APP_HOME%\lib\j2objc-annotations-1.3.jar


@rem Execute homework
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %HOMEWORK_OPTS%  -classpath "%CLASSPATH%" zoo.Main %*
...
if not ""=="%HOMEWORK_EXIT_CONSOLE%" exit %EXIT_CODE%
exit /b %EXIT_CODE%
